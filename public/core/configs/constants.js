...
exports.pageWidgetStringTemplate = exports.pageStringTemplate = exports.implementationStringTemplate = exports.remoteSourceStringTemplate = exports.localSourceStringTemplate = exports.domainFacadeStringTemplate = exports.domainFailureStringTemplate = exports.domainModelStringTemplate = exports.blocStateStringTemplate = exports.blocEventStringTemplate = exports.blocStringTemplate = void 0;
exports.blocStringTemplate = `import '../../domain/\${moduleSnake}/i_\${moduleSnake}_facade.dart';
...
`;
exports.blocEventStringTemplate = `part of '\${moduleSnake}_bloc.dart';
...
exports.blocStateStringTemplate = `part of '\${moduleSnake}_bloc.dart';
...
exports.domainModelStringTemplate = `import 'dart:convert';
...
`;
exports.domainFailureStringTemplate = `import 'package:freezed_annotation/freezed_annotation.dart';
...
`;
exports.domainFacadeStringTemplate = `import 'package:dartz/dartz.dart';
...
`;
exports.localSourceStringTemplate = `import 'package:hive/hive.dart';
...
`;
exports.remoteSourceStringTemplate = `import '../../../../domain/\${moduleSnake}/\${moduleSnake}.dart';
...
`;
exports.implementationStringTemplate = `import '../../../domain/\${moduleSnake}/i_\${moduleSnake}_facade.dart';
import '../../../domain/\${moduleSnake}/\${moduleSnake}.dart';
...
`;
exports.pageStringTemplate = `import '../../core/imports/presentation.essentials.barrel.dart';
...
`;
exports.pageWidgetStringTemplate = `import '../../../../application/\${moduleSnake}/\${moduleSnake}_bloc.dart';
